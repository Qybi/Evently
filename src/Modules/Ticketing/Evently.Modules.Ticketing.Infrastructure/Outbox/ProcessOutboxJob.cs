...
internal sealed class ProcessOutboxJob(TicketingDbContext ticketingDbContext,
    ...
    ILogger<ProcessOutboxJob> logger) : IJob
{
    ...
    public async ValueTask Execute(IJobExecutionContext context, CancellationToken cancellationToken = default)
    {
        ...
        await using IDbContextTransaction transaction = await ticketingDbContext.Database.BeginTransactionAsync(cancellationToken);
        ...
        await ticketingDbContext.SaveChangesAsync(cancellationToken);
    ...
    private async Task<IReadOnlyList<OutboxMessage>> GetOutboxMessagesAsync(CancellationToken cancellationToken)
    {
        ...
        List<OutboxMessage> outboxMessages = await ticketingDbContext.Set<OutboxMessage>()
            .FromSql($"""
                SELECT *
