...
internal sealed class ProcessInboxJob(AttendanceDbContext attendanceDbContext,
    ...
    ILogger<ProcessInboxJob> logger) : IJob
{
    ...
    private async Task<IReadOnlyList<InboxMessage>> GetInboxMessagesAsync(CancellationToken cancellationToken)
    {
        ...
        List<InboxMessage> inboxMessages = await attendanceDbContext.Set<InboxMessage>()
            .FromSql($"""
                SELECT *
