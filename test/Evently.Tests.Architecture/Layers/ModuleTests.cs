...
using Evently.Tests.Architecture.Abstractions;
using NetArchTest.Rules;

namespace Evently.Tests.Architecture.Layers;
...
public class ModuleTests : BaseTest
{
    ...
    public void UsersModule_ShouldNotHaveDependencyOn_AnyOtherModule()
    {
        ...
        // checking that modules are not interdependent between each other, leaving aside from integration events, since a module CAN listen for an integration event of another module
